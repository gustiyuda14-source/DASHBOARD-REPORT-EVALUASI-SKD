...
export function init(students) {
  ...
  chart = new Chart(document.getElementById('chartKumulatif'), {
    ...
    options: {
      ...
      scales: { y: { min: 50, max: 510, grid: { color: 'rgba(0,0,0,.05)' }, ticks: { stepSize: 50 }, title: { display: true, text: 'Rata-rata Skor Total' } }, x: { grid: { display: false }, ticks: { font: { size: 11 } } } }
    }
  });
